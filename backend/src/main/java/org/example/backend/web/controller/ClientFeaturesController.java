...
public class ClientFeaturesController {
    ...
    public ResponseEntity<List<LoginHistory>> myLoginHistory(Principal principal) {
        return ResponseEntity.ok(loginHistoryRepository.findByEmailOrderByCreatedAtDesc(principal.getName()));
    }
}
